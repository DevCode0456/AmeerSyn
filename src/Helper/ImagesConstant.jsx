let Images = {
  ...
  NETWORKING_IMG: require("../Assets/Images/Services/networking.jpg"),
  PROGRAMING_IMG: require("../Assets/Images/Services/custom program.jpg"),
  FINAL_YEAR_IMG: require("../Assets/Images/Services/final year project.jpg"),

  CLOUD_COMPUTING_IMG: require("../Assets/Images/Services/cloud.avif"),
  PROOF_READING_IMG: require("../Assets/Images/Services/Proof reading.jpg"),
  RESEARCH_WORK_IMG: require("../Assets/Images/Services/research paper.jpg"),
  DATA_STRUCTURE_IMG: require("../Assets/Images/Services/datastructure.avif"),
  CYBER_SECURITY_IMG: require("../Assets/Images/Services/cyber-security.jpg"),

  NETWORK_DESIGNE_IMG: require("../Assets/Images/Common/NetworkDesigne.jpeg"),
  OPERTAING_SYSTEM_IMG: require("../Assets/Images/Services/Operating-system.jpg"),
  ...
  ABOUT_PAGE_IMG: require("../Assets/Images/Common/aboutus.png"),
  ...
  CONTACT_US_IMG: require("../Assets/Images/Services/getstarted.jpg"),
  THESIS_WRITING_IMG: require("../Assets/Images/Services/Thesis.avif"),
  GET_STARTED_IMG: require("../Assets/Images/Services/getstarted.png"),
  TESTIMONIAL_IMG: require("../Assets/Images/Services/testimonials.jpg"),
  PENTRATION_TESTING: require("../Assets/Images/Services/penetating.avif"),
  PRIVACY_POLICY_IMG: require("../Assets/Images/Services/privacy-policy.jpg"),
  EMAIL_INVOICES_IMG: require("../Assets/Images/Services/email_invoice.avif"),
