...
const CustomCard = ({ icon, title, description }) => {
  return (
    <div className="relative w-full max-w-[230px] sm:max-w-[280px] md:max-w-xs lg:max-w-sm mx-auto mb-6">
      {/* Layered Backgrounds */}
      ...
      >
        ...
        <p className="text-center text-gray-500 text-sm mt-2">{description}</p>

        <Link
          to="/contact-us"
          className="flex items-center justify-between mt-4 bg-gradient-to-r from-orange-400 to-pink-500 p-2 rounded-full shadow-inner"
        >
